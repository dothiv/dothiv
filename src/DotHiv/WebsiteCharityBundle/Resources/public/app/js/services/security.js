 ...
 * @requires $http, $templateCache, authServer, dothivLoginResource, dothivUserResource
 * 
 * @description
 ...
 * - **`logout()`** Logs the user out. No error is thrown if nobody is logged in. On success the angular template cache is flushed. Argument is:
