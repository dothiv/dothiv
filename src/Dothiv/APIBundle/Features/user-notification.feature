...
Feature: See user notifications
  ...
  Scenario: Mark notification read
    Given I send a PATCH request to "http://click4life.hiv.dev/api/notification/1" with JSON values:
      | dismissed | 1 |
    Then the response status code should be 204
    # The notification should be updated
    When I send a GET request to "http://click4life.hiv.dev/api/notification/1"
