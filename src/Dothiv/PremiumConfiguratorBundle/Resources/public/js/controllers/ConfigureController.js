...
angular.module('dotHIVApp.controllers').controller('ConfigureController',
    ['$rootScope', '$scope', 'dothivBannerResource', 'dothivPremiumBannerResource', 'config', '$state', '$modal', '$timeout', 'AttachmentUploader', '$http', '$window', 'ContentBehaviour',
        function ($rootScope, $scope, dothivBannerResource, dothivPremiumBannerResource, config, $state, $modal, $timeout, AttachmentUploader, $http, $window, ContentBehaviour) {
