...
z+=m;}else{if(item[o.text]=='<a href="" title=""></a><br><br>'){opt.remove=opt.remove+','+q;}else{if(o.thumb==true){z='<span class="section-text-fb">'+item[o.text]+'</span>';var src=getImg(item.content);if(src){y='<a href="'+q+'"><img src="'+src+'" alt="" /></a>';}}else{z=item[o.text];}}}
