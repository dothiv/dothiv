 ...
 */
interface NonProfitRegistrationRepositoryInterface extends ObjectRepository, CRUD\PaginatedReadEntityRepositoryInterface, CRUD\UpdateEntityRepositoryInterface
{
    /**
     * Persist the entity.
     *
